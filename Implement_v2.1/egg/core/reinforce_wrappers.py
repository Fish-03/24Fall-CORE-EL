...
class SymbolGameReinforce(nn.Module):
    ...
    def forward(self, sender_input, labels, receiver_input=None, aux_input=None):
        ...
        # print(f"message:{message.shape}, receiver_input:{receiver_input}, aux:{aux_input}")
    ...
    # def test_forward(self, sender_input, labels, receiver_input=None, aux_input=None):
    #     # print(aux_input)
    #     message, sender_log_prob, sender_entropy = self.sender(sender_input, aux_input)
    #     # print(f"message:{message.shape}, receiver_input:{receiver_input}, aux:{aux_input}")
...
class CommunicationRnnReinforce(nn.Module):
    ...
    def forward(
        ...
        losslist, aux_info = loss(
            sender_input, message, receiver_input, receiver_output, labels, aux_input
        )
        loss, accuracy = losslist
        ...
        return [optimized_loss, accuracy], interaction
